...
func (Role) Descriptor() protoreflect.EnumDescriptor {
	return file_stakeholders_proto_enumTypes[0].Descriptor()
}

func (Role) Type() protoreflect.EnumType {
	return &file_stakeholders_proto_enumTypes[0]
}
...
const file_stakeholders_proto_rawDesc = "" +
	"\n" +
	"\x12stakeholders.proto\x12\x0fstakeholders.v1\"Z\n" +
...
var file_stakeholders_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
func file_stakeholders_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_stakeholders_proto_enumTypes,

...
const (
	...
	TourService_UpdateTourSales_FullMethodName  = "/tour.TourService/UpdateTourSales"
)
...
type TourServiceClient interface {
	...
	UpdateTourSales(ctx context.Context, in *UpdateTourSalesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *tourServiceClient) UpdateTourSales(ctx context.Context, in *UpdateTourSalesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, TourService_UpdateTourSales_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TourServiceServer interface {
	...
	UpdateTourSales(context.Context, *UpdateTourSalesRequest) (*emptypb.Empty, error)
...
func (UnimplementedTourServiceServer) UpdateTourSales(context.Context, *UpdateTourSalesRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTourSales not implemented")
}
...
func _TourService_UpdateTourSales_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTourSalesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TourServiceServer).UpdateTourSales(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TourService_UpdateTourSales_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TourServiceServer).UpdateTourSales(ctx, req.(*UpdateTourSalesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TourService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTourSales",
			Handler:    _TourService_UpdateTourSales_Handler,
		},
	},

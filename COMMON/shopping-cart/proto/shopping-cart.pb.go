...
func (x *PurchaseCheckRequest) Reset() {
	*x = PurchaseCheckRequest{}
	mi := &file_shopping_cart_proto_shopping_cart_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PurchaseCheckRequest) Descriptor() ([]byte, []int) {
	return file_shopping_cart_proto_shopping_cart_proto_rawDescGZIP(), []int{10}
}
...
func (x *PurchaseCheckResponse) Reset() {
	*x = PurchaseCheckResponse{}
	mi := &file_shopping_cart_proto_shopping_cart_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PurchaseCheckResponse) Descriptor() ([]byte, []int) {
	return file_shopping_cart_proto_shopping_cart_proto_rawDescGZIP(), []int{11}
}
...
const file_shopping_cart_proto_shopping_cart_proto_rawDesc = "" +
	...
	"\x06tokens\x18\x01 \x03(\v2\x1c.shopping_cart.PurchaseTokenR\x06tokens\"H\n" +
	"\x14PurchaseCheckRequest\x12\x17\n" +
	"\atour_id\x18\x01 \x01(\tR\x06tourId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\">\n" +
	"\x15PurchaseCheckResponse\x12%\n" +
	"\x0etour_purchased\x18\x01 \x01(\bR\rtourPurchased2\xdd\x05\n" +
	...
	"\x11GetPurchasedTours\x12'.shopping_cart.GetPurchasedToursRequest\x1a(.shopping_cart.GetPurchasedToursResponse\"+\x82\xd3\xe4\x93\x02%\x12#/api/shopping-cart/orders/{user_id}\x12^\n" +
...
var file_shopping_cart_proto_shopping_cart_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_shopping_cart_proto_shopping_cart_proto_goTypes = []any{
	...
	(*PurchaseCheckRequest)(nil),      // 10: shopping_cart.PurchaseCheckRequest
	(*PurchaseCheckResponse)(nil),     // 11: shopping_cart.PurchaseCheckResponse
}
var file_shopping_cart_proto_shopping_cart_proto_depIdxs = []int32{
	...
	10, // 8: shopping_cart.ShoppingCartService.IsTourPurchased:input_type -> shopping_cart.PurchaseCheckRequest
	1,  // 9: shopping_cart.ShoppingCartService.GetCart:output_type -> shopping_cart.CartResponse
	1,  // 10: shopping_cart.ShoppingCartService.AddItem:output_type -> shopping_cart.CartResponse
	1,  // 11: shopping_cart.ShoppingCartService.RemoveItem:output_type -> shopping_cart.CartResponse
	7,  // 12: shopping_cart.ShoppingCartService.Checkout:output_type -> shopping_cart.CheckoutResponse
	9,  // 13: shopping_cart.ShoppingCartService.GetPurchasedTours:output_type -> shopping_cart.GetPurchasedToursResponse
	11, // 14: shopping_cart.ShoppingCartService.IsTourPurchased:output_type -> shopping_cart.PurchaseCheckResponse

...
type BlogServiceClient interface {
	...
	ToggleLike(ctx context.Context, in *ToggleLikeRequest, opts ...grpc.CallOption) (*PostResponse, error)
...
func (c *blogServiceClient) GetAllPosts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllPostsResponse, error) {
...
func (c *blogServiceClient) ToggleLike(ctx context.Context, in *ToggleLikeRequest, opts ...grpc.CallOption) (*PostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PostResponse)
...
type BlogServiceServer interface {
	...
	// HTTP: POST /api/blog/posts/{post_id}/like
	// We get UserID from Metadata (X-User-Id), so we only need PostId here
	ToggleLike(context.Context, *ToggleLikeRequest) (*PostResponse, error)
	// HTTP: GET /api/blog/posts/{post_id}/comments
...
func (UnimplementedBlogServiceServer) GetAllPosts(context.Context, *emptypb.Empty) (*GetAllPostsResponse, error) {
...
func (UnimplementedBlogServiceServer) ToggleLike(context.Context, *ToggleLikeRequest) (*PostResponse, error) {

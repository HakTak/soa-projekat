...
func (s *TourService) GetTourExecutionByTourUser(tourId, touristId string) (*model.TourExecution, error) {
	return s.tourExecutionRepo.GetByTourUser(tourId, touristId)
}
